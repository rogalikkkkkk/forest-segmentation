...
UNET_RESNET34_SPEC = ModelSpec(
    ...
    visualization_indices=tuple(UNET_RESNET34_VISUALIZATION_INDICES),
...
SEGFORMER_B0_SPEC = ModelSpec(
    ...
    visualization_indices=tuple(SEGFORMER_B0_VISUALIZATION_INDICES),
...
DEEPLABV3PLUS_RESNET50_SPEC = ModelSpec(
    ...
    visualization_indices=tuple(DEEPLABV3PLUS_RESNET50_VISUALIZATION_INDICES),
