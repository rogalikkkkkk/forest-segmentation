...
def parse_args():
    parser = argparse.ArgumentParser(description="Visualize SegFormer-B0 predictions.")
...
def main():
    ...
    if not checkpoint_path.exists():
        if run_dir is not None:
            raise FileNotFoundError(
                ...
                "Run scripts/train_segformer_b0.py with the same --run-dir first."
            )
        raise FileNotFoundError(
    ...
    print("SegFormer-B0 predictions visualization")
    print("=" * 60)
