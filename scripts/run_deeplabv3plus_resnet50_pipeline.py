...
def print_results_summary(run_dir=None):
    ...
    history_path = get_run_artifact_path(
        DEEPLABV3PLUS_RESNET50_HISTORY_PATH,
        run_dir,
    )
    step_history_path = get_run_artifact_path(
        DEEPLABV3PLUS_RESNET50_STEP_HISTORY_PATH,
        run_dir,
    )
    metrics_path = get_run_artifact_path(DEEPLABV3PLUS_RESNET50_METRICS_PATH, run_dir)
    best_metrics_path = get_run_artifact_path(
        DEEPLABV3PLUS_RESNET50_BEST_METRICS_PATH,
        run_dir,
    )
