...
def main():
    ...
    artifacts_dir = run_dir if run_dir is not None else DEEPLABV3PLUS_RESNET50_OUTPUT_DIR
    artifacts_dir.mkdir(parents=True, exist_ok=True)
    checkpoint_path = artifacts_dir / DEEPLABV3PLUS_RESNET50_CHECKPOINT_PATH.name
    best_checkpoint_path = artifacts_dir / DEEPLABV3PLUS_RESNET50_BEST_CHECKPOINT_PATH.name
    history_path = artifacts_dir / DEEPLABV3PLUS_RESNET50_HISTORY_PATH.name
    step_history_path = artifacts_dir / DEEPLABV3PLUS_RESNET50_STEP_HISTORY_PATH.name
    best_metrics_path = artifacts_dir / DEEPLABV3PLUS_RESNET50_BEST_METRICS_PATH.name
    training_curves_path = artifacts_dir / DEEPLABV3PLUS_RESNET50_TRAINING_CURVES_PATH.name
    step_loss_curve_path = artifacts_dir / DEEPLABV3PLUS_RESNET50_STEP_LOSS_CURVE_PATH.name
